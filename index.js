...
// Telegram Bot
tgbot.start(ctx => ctx.replyWithMarkdown(`Hey **${ctx.message.from.first_name}**, Welcome! \nI can notify you about new messages of WhatsApp. \n\nPowered by [Ayush Sharma](https://t.me/AayushKumarSharma).`,
  {disable_web_page_preview: true,
   reply_markup:{
    inline_keyboard: [[{text:'Ayush', url:'www.google.com'}]]
  }}
));
tgbot.command('donate', ctx => { // Donate Command
  ctx.replyWithMarkdown('Thank you for using',
  {disable_web_page_preview: true,
   reply_markup:{
     inline_keyboard: [[{text: 'Ko-fi', url: 'www.google.com'}]]
  }})
});
